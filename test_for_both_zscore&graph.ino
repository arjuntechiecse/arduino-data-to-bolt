...
#ifndef API_KEY
#define API_KEY   "xxxxxxxxxxxxxxxxxxxxxx"
#endif
#ifndef DEVICE_ID
#define DEVICE_ID "BOLTxxxxx"
#endif
...
void setup(){
  ...
  boltiot.setCommandString("RD\r",getAnalogData);//changed line for graph generation(not working)
  boltiot.setCommandString("RD\r",pushData);//added this here for z-score analysis
